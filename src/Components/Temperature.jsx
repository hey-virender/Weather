...
export const Temperature = ({ setCity, stats }) => {
  ...
  return (
    <>
      ...
      <div className="flex justify-center mt-8">
        {stats.isDay !== 0 ? (
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-16 h-16 text-yellow-300 text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      <div className="flex justify-center items-center text-slate-300 mt-8 text-[24px] text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer">
        {stats.condition}
      </div>
      <div className="flex justify-center mt-5 text-[15px] text-slate-400 cursor-pointer">
