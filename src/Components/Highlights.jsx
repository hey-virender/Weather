...
export const Highlights = ({ stats }) => {
  return (
    <div className="bg-slate-600 p-2 text-slate-200 flex-col justify-start items-center text-center text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer">
