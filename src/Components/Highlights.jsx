...
export const Highlights = ({ stats }) => {
  return (
    <div className="bg-slate-600 p-2 text-slate-200 flex-col justify-start items-center text-center text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer rounded-md">
      ...
      {stats.title == "Humidity" ? (
        <div className="w-full bg-gray-200 rounded-full h-1.5 mb-4 mt-4 dark:bg-gray-700">
          <div
            ...
            style={{ width: `${stats.value}${stats.unit}` }}
          ></div>
        </div>
      ) : null}
    </div>
